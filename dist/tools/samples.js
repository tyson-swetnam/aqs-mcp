...
const paramProperty = {
    param: {
        type: 'string',
        description: 'Parameter code (e.g., 44201 for Ozone, 88101 for PM2.5, 42401 for SO2, 42101 for CO, 42602 for NO2, 81102 for PM10).',
    },
};
/**
 ...
 */
function formatSampleDataResponse(data, endpoint) {
